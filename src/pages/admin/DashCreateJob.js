...
const DashCreateJob = () => {
    ...
    return (
        <>
            ...
            <Box sx={{ height: '100%', display: "flex", alignItems: "center", justifyContent: "center",minWidth:"300px", pt: 4 }}>


                <Box onSubmit={formik.handleSubmit} component="form" className='form_style border-style'sx={{minWidth:"300px", color: 'text.secondary',}} >
